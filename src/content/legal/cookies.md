...
In this Cookies Policy, we use the terms "we", "us" and "our" to refer to Appwrite Code Ltd. Our Privacy Policy is available at [Privacy Policy](/privacy).
...
| Cookie name | Source | Expiry (In days) | Purpose |
| --- | --- | --- | --- |
| __stripe_sid | Stripe | Session | Address collection for receipts |
| __stripe_mid | Stripe | 365 | Enable the website to process payments without storing any credit card information |
