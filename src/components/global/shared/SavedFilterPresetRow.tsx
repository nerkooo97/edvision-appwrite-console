...
export type SavedFilterPresetRowProps = {
  item: SavedFilterPresetItem
  canEdit: boolean
  ...
  deleteBusy: boolean
  /** True while any row's delete is in flight (disables all delete controls) */
...
/**
 * One saved filter row: drag handle, name (inline rename), apply, delete.
 * Rename is isolated per row (no shared editing state) with explicit affordances.
 */
