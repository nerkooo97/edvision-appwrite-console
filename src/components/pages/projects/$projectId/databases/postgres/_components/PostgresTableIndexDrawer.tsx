...
export function PostgresTableIndexDrawer({
  open,
  onOpenChange,
  projectId,
  databaseId,
  ...
  const handleSubmit = async () => {
    ...
    try {
      const statements = [
        buildPostgresCreateIndexSql(tableId, trimmedName, formState.columns, {
      ...
      if (formState.comment.trim()) {
        statements.push(
          buildPostgresIndexCommentSql(schema, trimmedName, formState.comment.trim()),
        )
      }
