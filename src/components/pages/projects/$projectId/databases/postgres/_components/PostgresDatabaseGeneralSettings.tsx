...
export type { PostgresDatabaseSettingsCardProps } from './postgres-database-settings-types'
...
export function PostgresDatabaseNameCard({
  projectId,
  databaseId,
  database,
  canWrite,
...
export function PostgresDatabaseDetailsCard({
  projectId,
  databaseId,
  database,
  canWrite,
...
export function PostgresDatabaseComputeTierCard({
  projectId,
  databaseId,
  database,
  canWrite,
