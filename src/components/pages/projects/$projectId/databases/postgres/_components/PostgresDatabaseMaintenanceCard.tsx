...
import {
  ...
  getUserTimeZone,
  usePostgresMaintenanceWindow,
} from './postgres-maintenance-shared'
...
type MaintenanceWeekHourGridProps = {
  ...
  t: ReturnType<typeof usePostgresMaintenanceWindow>['t']
}
...
export function PostgresDatabaseMaintenanceCard({
  projectId,
  databaseId,
  database,
  canWrite,
