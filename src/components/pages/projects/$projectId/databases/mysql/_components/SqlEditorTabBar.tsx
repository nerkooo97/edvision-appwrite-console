...
import { MAX_MYSQL_SQL_EDITOR_TAB_TITLE_LENGTH } from '@/lib/user-prefs-keys'
import type { SqlEditorTab } from './MysqlSidebarContext'
          ...
          >
            {isEditing ? (
              <Input
                ref={editInputRef}
                value={draftTitle}
                maxLength={MAX_MYSQL_SQL_EDITOR_TAB_TITLE_LENGTH}
