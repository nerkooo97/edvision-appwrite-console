...
import type { MysqlTableIndexRow } from '@/lib/mysql-sql'
import { useT } from '@/lib/i18n/translate'

interface MysqlIndexContextMenuProps {
  index: MysqlTableIndexRow
  canWrite?: boolean
  onDelete: (indexName: string) => void
  children: React.ReactNode
}

export function MysqlIndexContextMenu({
  index,
  canWrite = true,
  onDelete,
  children,
}: MysqlIndexContextMenuProps) {
  const t = useT()
  return (
    <ContextMenu>
