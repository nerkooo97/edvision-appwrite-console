...
import { useDeleteMysqlDatabase } from '@/lib/react-query/hooks'
import { getErrorMessage } from '@/lib/utils/error-formatting'
import { useT } from '@/lib/i18n/translate'

type MysqlDatabaseDangerZoneCardProps = {
  projectId: string
  database: Models.DedicatedDatabase
  canWrite: boolean
}

export function MysqlDatabaseDangerZoneCard({
  projectId,
  database,
  canWrite,
}: MysqlDatabaseDangerZoneCardProps) {
  const t = useT()
