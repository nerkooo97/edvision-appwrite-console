...
{% only_dark %}
![Create database type selection](/images/docs/products/databases/mysql/dark/create-database-type.avif)
{% /only_dark %}
{% only_light %}
...
{% only_dark %}
![Database specifications](/images/docs/products/databases/mysql/dark/create-database-specs.avif)
{% /only_dark %}
{% only_light %}
...
# Connect with the mysql client {% #mysql-client %}
...
Connect from your application with any MySQL driver or ORM.
{% /cards_item %}
...
Add read replicas with automatic failover.
{% /cards_item %}
{% cards_item href="/docs/products/databases/mysql/monitoring" title="Monitoring" %}
Poll live health and status information from your pipelines.
{% /cards_item %}
{% /cards %}
`;export{e as default};