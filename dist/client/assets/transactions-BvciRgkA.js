...
Two distinct things go wrong without that:
...
Transactions address both, which is why they exist: statements apply atomically, and the database isolates transactions from each other's unfinished work. InnoDB, the default storage engine, provides full transaction support.

# How a transaction works {% #how-it-works %}
...
{% info title="DDL commits implicitly" %}
...
# A failed statement does not abort the transaction {% #errors %}
...
# Transactions and pooling {% #pooling %}
