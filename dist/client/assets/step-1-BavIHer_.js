...
{% only_dark %}
![Create project screen](/images/docs/tutorials/refine/refine-admin-panel-dark.avif)
{% /only_dark %}
{% only_light %}
...
2. Have [Node.js](https://nodejs.org/en) and [NPM](https://www.npmjs.com/) installed on your computer`;export{e as default};