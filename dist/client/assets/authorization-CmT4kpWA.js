...
{% only_dark %}
![The authorization code flow between the browser, the client, the OAuth2 server, and your consent screen](/images/docs/oauth-server/dark/diagram-authorization.avif)
{% /only_dark %}
{% only_light %}
...
# 1. Send the user to the authorization endpoint {% #authorize %}
...
# 2. Host the consent screen {% #consent %}
...
## Find or create the grant {% #resolve-grant %}
...
### Create the grant after sign-in {% #create-grant-after-sign-in %}
...
## Record the user's decision {% #decision %}
...
## Consent screen best practices {% #consent-best-practices %}
...
# Device flow authorization {% #device-flow %}
