import{l4 as e,lat as t,nat as n}from"./main-uHRHOkhm.js";import"./PolicySidebarNav-VtGjukax.js";import"./PolicyToc-CFZz3xFT.js";import"./PricingSectionHeading-Bh5jHpq9.js";import{t as r}from"./View-D6Dpuk4x.js";var i=`This Business Associate Agreement ("BAA") applies to clients under the scale plan or the startups program.

This BAA is made and entered into as of the effective date ("Effective Date") and forms an integral part of the underlying agreement entered into by the parties ("Agreement") and pursuant the services given under the Agreement ("Services"). This BAA is entered into by Customer ("Customer" or "Covered Entity") and Appwrite Code Inc. ("Company" or "Business Associate"). Both parties shall be referred to as the "Parties" and each, a "Party".

Whereas, Customer is subject to the Health Insurance Portability and Accountability Act of 1996, as amended by the Health Information Technology for Economic and Clinical Health Act ("Hitech"), and as may be further modified or superseded from time to time, (collectively "HIPAA Rules"), and among other obligations under HIPAA are required to enter into agreements with respect to the use and disclosure and safeguarding of PHI
...
- Use commercially reasonable efforts to ensure that it Subcontractors that process PHI on Company's behalf are subject to substantially the same restrictions and conditions concerning the processing of PHI contained in this BAA and agree to implement reasonable and appropriate safeguards to protect any PHI. Customer hereby agrees that Company may disclose PHI to Subcontractors and others who assist in the provision of services to Customer.

- Reasonably assist in ten (10) business days the Customer to comply with Individuals requests related to their PHI in accordance with the HIPAA Rules requirements (e.g., to make available in a designated record set to the Customer to meet Customer's obligations under 45 CFR 164.524 or make any amendment(s) to PHI in a designated record set as agreed to by the Customer pursuant to 45 CFR 164.526); provided that Customer informs in writing Company of the applicable request.
...
**Effect of Termination.** Upon termination of the Agreement or this BAA for any reason, all PHI maintained by Company will be returned to Customer or destroyed. Company shall be allowed to retain a copy of the de-identified data, as permitted in Section 2.1. In any event, to the extent required or allowed by applicable law, Company may retain one copy of the PHI for evidence purposes and/or for the establishment, exercise or defence of legal claims and/or to comply with applicable laws and regulations. This Section, and Sections 5 and 6 will survive any termination of this BAA.
...
**Notice.** All communications and notices shall be in writing, delivered personally, by email or sent through any mailing services to the addresses set forth in the signature page below.
...
`,a=t(n());function o(){return(0,a.jsx)(r,{title:e()(`Business Associate Agreement`),content:i})}export{o as component};