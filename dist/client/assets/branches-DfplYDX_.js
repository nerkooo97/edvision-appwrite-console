...
# List branches and connect {% #list %}
...
\`\`\`bash
mysql --defaults-extra-file=<(printf '[client]\\npassword=%s\\n' "$BRANCH_PASSWORD") -h <branch host> -P 3306 -u admin -D <branch database>
\`\`\`
