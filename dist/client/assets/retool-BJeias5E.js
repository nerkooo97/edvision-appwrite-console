...
# Create the MySQL resource {% #resource %}
...
{% arrow_link href="/docs/products/databases/mysql/connection-pooling#modes" %}
...
{% arrow_link href="/docs/products/databases/mysql/network-security#ip-allowlist" %}
...
Create and manage a native MySQL database.
{% /cards_item %}
