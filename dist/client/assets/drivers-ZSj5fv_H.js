...
# mysql2 promise API {% #mysql2-promise %}
...
# mysql2 callback API {% #mysql2-callback %}
...
# MariaDB Connector/Node.js {% #mariadb %}
...
Retrieve credentials, rotate the password, and connect with common clients.
{% /cards_item %}
