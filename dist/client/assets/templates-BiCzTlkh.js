...
You can find all available templates by navigating to the Appwrite Console under your project >\xA0**Sites**\xA0>\xA0**Templates**.
...
You can filter sites by searching, filter by use case, or filter by framework. Click\xA0**Create site**\xA0to create a site from a template.
...
If you choose to connect to an existing repository intead of creating a new one, you must specify the output folder of your build under the [Branch](#select-a-production-branch)\xA0step.
...
When a PR is made to the branch, a new deployment is built and a preview URL becomes available. A comment is made to your PR about the build unless you enable\xA0**Silent mode**.

## Add required environment variables

Appwrite Sites uses\xA0environment variables\xA0to pass constants and secrets to your sites. You can provide information like API keys and other secrets in this step.

## Configure domain name

Configure the subdomain of the Appwrite Site to be deployed. Once deployment completes, your application will be available to access on this domain. You can also [add a custom domain](/docs/products/sites/domains#add-a-custom-domain) to this site later.`;export{e as default};