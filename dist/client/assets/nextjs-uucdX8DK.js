...
# Create a table for the examples {% #table %}
...
# Pool serverless connections {% #pooling %}
...
{% arrow_link href="/docs/products/databases/mysql/integrations/prisma" %}
Set up Prisma against native MySQL
{% /arrow_link %}
...
{% arrow_link href="/docs/products/databases/mysql/quick-start#first-queries" %}
...
{% /cards_item %}
{% cards_item href="/docs/products/databases/mysql/quick-start#first-queries" title="SQL API" %}
