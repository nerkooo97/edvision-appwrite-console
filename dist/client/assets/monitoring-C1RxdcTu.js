...
{% only_dark %}
![Database monitor tab](/images/docs/products/databases/postgresql/dark/monitor.avif)
{% /only_dark %}
{% only_light %}
...
{% only_dark %}
![Active connections tab](/images/docs/products/databases/postgresql/dark/connections.avif)
{% /only_dark %}
{% only_light %}
