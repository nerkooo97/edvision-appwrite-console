...
{% info title="Restores overwrite current data" %}
...
{% only_dark %}
![Point-in-time recovery settings](/images/docs/products/databases/postgresql/dark/settings-pitr.avif)
{% /only_dark %}
{% only_light %}
...
## Check the recovery window {% #pitr-windows %}
