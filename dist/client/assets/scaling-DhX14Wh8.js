...
# List available specifications {% #specifications %}
...
# Change the compute specification {% #resize %}

{% only_dark %}
![Compute tier settings](/images/docs/products/databases/postgresql/dark/settings-compute-tier.avif)
{% /only_dark %}
{% only_light %}
...
# Storage autoscaling {% #autoscaling %}
...
# Picking a specification {% #picking %}
