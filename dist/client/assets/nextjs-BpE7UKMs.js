...
{% arrow_link href="/docs/products/databases/postgresql/integrations/prisma" %}
Set up Prisma against native PostgreSQL
{% /arrow_link %}
...
{% arrow_link href="/docs/products/databases/postgresql/quick-start#first-queries" %}
...
{% /cards_item %}
{% cards_item href="/docs/products/databases/postgresql/quick-start#first-queries" title="SQL API" %}
