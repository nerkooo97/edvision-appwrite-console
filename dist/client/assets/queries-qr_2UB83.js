...
{% info title="Filter metadata with string values" %}
...
appwrite vectors-db list-documents \\
    ...
    --queries '{"method":"equal","attribute":"metadata.genre","values":["sci-fi","drama"]}' '{"method":"greaterThan","attribute":"metadata.year","values":["2010"]}'
\`\`\`
{% /multicode %}
