...
# What a join actually does {% #what-a-join-does %}
...
{% info title="FULL parses as an alias" %}
...
# Anti-joins: rows without a match {% #anti-join %}
...
# Join or separate queries? {% #vs-n-plus-1 %}
