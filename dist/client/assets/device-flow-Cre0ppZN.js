...
{% only_dark %}
![The device shows a short code, the user approves it on a second device, and the device polls for tokens](/images/docs/partners/apps/dark/diagram-device.avif)
{% /only_dark %}
{% only_light %}
