...
{% only_dark %}
![Your app exchanges the code for tokens, calls granted projects, renews with the refresh token, and revokes when done](/images/docs/partners/apps/dark/diagram-tokens.avif)
{% /only_dark %}
{% only_light %}
