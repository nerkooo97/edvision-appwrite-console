...
# OAuth connect architecture {% #oauth-connect-architecture %}
...
# Org API key architecture {% #org-api-key-architecture %}
...
Learn more in [Org API keys](/docs/partners/org-api-keys).

# Console SDK vs project SDK {% #console-sdk-vs-project-sdk %}

| SDK | Endpoint project | Manages |
| --- | ---------------- | ------- |
| Console (\`setProject('console')\`) | \`console\` | Organizations, projects, domains, org settings |
| Project (\`setProject('<PROJECT_ID>')\`) | Customer project | Databases, storage, functions, users, messaging |
...
{% arrow_link href="/docs/partners/guides/multi-tenancy" %}
