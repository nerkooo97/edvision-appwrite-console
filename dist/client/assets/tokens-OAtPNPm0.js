...
# The three tokens {% #tokens %}

{% only_dark %}
![The token endpoint issues access, refresh, and ID tokens, with refresh rotation and revocation](/images/docs/oauth-server/dark/diagram-tokens.avif)
{% /only_dark %}
{% only_light %}
...
# Exchange a code for tokens {% #exchange %}
...
# Sign out from the authorization server {% #logout %}
