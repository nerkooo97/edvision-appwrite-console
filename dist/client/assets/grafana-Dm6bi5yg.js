...
# Protect dashboard credentials {% #credentials %}
...
# Add the MySQL data source {% #data-source %}
...
{% cards %}
{% cards_item href="/docs/products/databases/mysql" title="MySQL databases" %}
...
{% arrow_link href="/docs/products/databases/mysql/connections" %}
Connect to a native MySQL database
{% /arrow_link %}
`;export{e as default};