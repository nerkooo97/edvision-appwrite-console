...
{% only_dark %}
![Functions domain](/images/docs/tutorials/subscriptions-with-stripe/dark/functions-stripe-domain.avif)
{% /only_dark %}
{% only_light %}
...
Update the **Endpoint URL** to \`https://<YOUR_FUNCTION_DOMAIN>/webhook\`. For example, \`https://6579ea96aa28a5cfb66a.fra.appwrite.run/webhook\``;export{e as default};