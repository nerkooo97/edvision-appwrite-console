...
# Mapping tenants {% #mapping-tenants %}
...
{% cards %}
{% cards_item href="/docs/partners/guides/provisioning" title="Provisioning" %}
Automate project creation on signup.
{% /cards_item %}
{% cards_item href="/docs/partners/architecture" title="Architecture" %}
Compare OAuth connect and org API keys.
{% /cards_item %}
{% /cards %}
`;export{e as default};