...
To switch to Windows mode, switch the preinstalled macOS keycap with the Windows keycap and use the\xA0\`FN + A\`\xA0shortcut to enable Windows mode; this will enable Windows-specific keyboard commands to work, like\xA0\`Ctrl + C\`\xA0or\xA0\`Ctrl + A\`.

## MacOS mode {% #macos-mode %}

To use macOS-specific keyboard commands such as\xA0\`Command + C\`\xA0or\xA0\`Command + A\`, keep the preinstalled macOS keycaps in and use the\xA0\`FN + S\`\xA0shortcut to enable macOS mode.
