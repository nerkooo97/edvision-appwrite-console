...
Each time a URL path on an Appwrite Site is requested, a\xA0log is created. Each log has a unique ID. You can find site logs logged in the\xA0**Logs** tab.

# Logs table

In your site's\xA0**Logs** tab, you will see a table of your recent logs. The following information is shown in this table:
...
If you need longer log retention, you can log to an Appwrite table. Remember to configure proper permissions and implement Appwrite Functions or other scheduled tasks to expire and clean up logs.`;export{e as default};