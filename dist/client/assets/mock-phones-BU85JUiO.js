...
# Add from the Console {% #toggle-console %}

{% only_dark %}
![Mock phone numbers settings in the Appwrite Console](/images/docs/project/dark/mock-phones.avif)
{% /only_dark %}
{% only_light %}
...
# Manage with a Server SDK {% #manage-with-sdk %}
...
## Create a mock phone {% #create-mock-phone %}
...
## List mock phones {% #list-mock-phones %}
...
## Get a mock phone {% #get-mock-phone %}
...
## Update a mock phone {% #update-mock-phone %}
...
## Delete a mock phone {% #delete-mock-phone %}
