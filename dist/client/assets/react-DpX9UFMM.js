...
{% section #step-3 step=3 title="Install the React library" %}
...
{% section #step-4 step=4 title="Configure environment variables" %}
...
{% section #step-5 step=5 title="Wrap your app with AppwriteProvider" %}
...
{% section #step-6 step=6 title="Add sign-up, sign-in, and sign-out" %}
...
{% section #step-7 step=7 title="Run your app" %}
Run your project.
