...
| \`ready\` | A deployment is built, but is not activated.\xA0Any \`ready\`\xA0deployment can be activated to replace the current active deployment. A ready deployment can also be [previewed](#preview-deployments) by authorized members of your Appwrite organization before activation. |
| \`building\` | A deployment is being built. Check the\xA0[deployment logs](#deployment-logs)\xA0for more info. |
...
| \`failed\` | A deployment was not successful. Check the\xA0[deployment logs](#deployment-logs)\xA0for more info for debugging. |
