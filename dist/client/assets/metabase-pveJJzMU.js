...
# Choose credentials for Metabase {% #credentials %}
...
# Add the database in Metabase {% #add-database %}
...
{% info title="Use a session-safe connection" %}
...
# Build a question or dashboard {% #build %}
...
# How Metabase syncs your schema {% #sync %}
...
# Use a branch for testing {% #branches %}
...
Provision and manage a native MySQL database for your project.
{% /cards_item %}
{% cards_item href="/docs/products/databases/mysql/connections" title="Connections" %}
Retrieve connection details and rotate the primary password.
{% /cards_item %}
