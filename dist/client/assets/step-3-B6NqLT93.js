...
Similarly, fill the \`STRIPE_WEBHOOK_SECRET\`\xA0variable with the secret copied after creating **Webhook**. 

If you are self-hosting Appwrite, you will need to change \`APPWRITE_ENDPOINT\`\xA0as well, under the **Optional variables** section. 
...
Finally, you can configure repository-related settings such as **Production branch**, **Root directory**, or **Silent mode**. Let's stick to the default values provided by the template and click the **Create** button to create the function.`;export{e as default};