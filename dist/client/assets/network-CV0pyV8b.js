...
{% /cards_item %}
{% cards_item href="/docs/products/firewall" title="Firewall" %}
Project rules to deny, rate limit, redirect, or bypass matching API, Functions, and Sites traffic.
{% /cards_item %}
