...
# Add the scopes to the request {% #request %}
...
# Label the scopes on the consent screen {% #label %}
...
Update the \`approve\` helper in \`provider/src/lib/oauth-server.ts\` to pass the chosen scopes:
