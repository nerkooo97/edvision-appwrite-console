...
Transactions address both, which is why they exist: statements apply atomically, and the database isolates transactions from each other's unfinished work.
...
# Errors abort the transaction {% #errors %}
