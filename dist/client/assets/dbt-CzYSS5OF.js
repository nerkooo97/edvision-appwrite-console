...
# Choose where dbt builds {% #build-location %}
...
# Configure profiles.yml {% #profiles %}
...
# Choose the right connection {% #connection %}
...
# Size threads to your connection budget {% #threads %}
...
{% arrow_link href="https://docs.getdbt.com/docs/local/connect-data-platform/mysql-setup" %}
dbt MySQL adapter reference
{% /arrow_link %}
`;export{e as default};