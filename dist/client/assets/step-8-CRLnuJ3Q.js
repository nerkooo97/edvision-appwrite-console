...
Replace \`<NuxtWelcome />\` with \`<NuxtPage />\` to allow the user to navigate to the pages created so far, such as the sign-up and account pages, instead of the default Nuxt welcome page.`;export{e as default};