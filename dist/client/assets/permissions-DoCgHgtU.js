...
Document level permissions are only applied if row level security is enabled in the security settings of your collection.
Enable document level permissions by navigating to **Your collection** > **Security** > **Row level security (RLS)**.
