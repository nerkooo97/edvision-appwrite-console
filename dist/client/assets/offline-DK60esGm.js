...
{% cards_item href="/integrations/replication-rxdb" title="RxDB" icon="rxdb" %}
{% /cards_item %}
...
6. **Conflict resolution**: If the same data was changed both locally and on the server, the system must prioritise one of the two operations. Various strategies can be implemented to mitigate this issue, such as *last write wins* or *manual user conflict resolution*.`;export{e as default};