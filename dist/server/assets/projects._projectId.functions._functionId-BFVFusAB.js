...
import { n as Layout } from "./Layout-DZ-9Wsbw.js";
import "./CreateManualDeploymentModal-CZJSSa3W.js";
import "./RepositoryPicker-BTzJ0oV8.js";
import { jsx } from "react/jsx-runtime";
import { Outlet, useMatches } from "@tanstack/react-router";
function LayoutWrapper() {
	if (useMatches().some((match) => match.routeId.includes("/deployments/$deploymentId") || match.routeId === "/_public/projects/$projectId/functions/$functionId/deployments/$deploymentId" || match.routeId.startsWith("/_public/projects/$projectId/functions/$functionId/deployments/$deploymentId"))) return /* @__PURE__ */ jsx(Outlet, {});
	return /* @__PURE__ */ jsx(Layout, {});
}
export { LayoutWrapper as component };
