...
import { dp as mysqlDatabaseQueryOptions, oh as useCreateDedicatedDatabaseFailover, sh as useDedicatedDatabaseReplicas } from "./hooks-BONwG3Mt.js";
...
import { a as MysqlDatabaseSyncModeCard, r as MysqlDatabaseReplicasCard } from "./MysqlDatabaseConfigSettings-se_DcGf0.js";
...
function MysqlDatabasePrimaryCard({ projectId, databaseId, database, canWrite, replicationSource, haEngine }) {
	const t = useT();
	...
	useEffect(() => {
		...
		queryClient.invalidateQueries({ queryKey: mysqlDatabaseQueryOptions(projectId, databaseId).queryKey });
	}, [
		databaseId,
		pollReplicas,
		projectId,
	...
	return /* @__PURE__ */ jsx(SettingsCardsList, { cards: [
		{
			...
			node: /* @__PURE__ */ jsx(MysqlDatabaseReplicasCard, { ...cardProps })
		},
		...database.replicas && database.replicas > 0 ? [{
			...
			node: /* @__PURE__ */ jsx(MysqlDatabasePrimaryCard, { ...cardProps })
		}] : [],
		{
			id: "sync-mode",
			search: {
			...
			node: /* @__PURE__ */ jsx(MysqlDatabaseSyncModeCard, { ...cardProps })
		}
	] });
}
