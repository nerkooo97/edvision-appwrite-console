...
import { a as UpdateEmailSection, n as DeleteAccountSection, o as UpdateNameSection, t as AccountIdSection } from "./Overview-DFHEPqcV.js";
	...
	return /* @__PURE__ */ jsx(SettingsCardsList, { cards: useMemo(() => [
		{
			...
			node: /* @__PURE__ */ jsx(AccountIdSection, {})
		},
		{
			id: "name",
			search: {
			...
			node: /* @__PURE__ */ jsx(UpdateNameSection, {})
		},
		{
			id: "email",
			search: {
			...
			node: /* @__PURE__ */ jsx(UpdateEmailSection, {})
		},
		{
			id: "delete-account",
			search: {
			...
			node: /* @__PURE__ */ jsx(DeleteAccountSection, {})
		}
	], []) });
}
function AccountGeneralPage() {
	return /* @__PURE__ */ jsx(AccountGeneral, {});
}
export { AccountGeneralPage as component };
