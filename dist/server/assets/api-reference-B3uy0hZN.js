...
var loadApiReferenceServiceFn = createServerFn({ method: "GET" }).inputValidator(referenceServiceSchema).handler(loadApiReferenceServiceFn_createServerFn_handler, async ({ data }) => {
...
var loadApiReferenceModelFn = createServerFn({ method: "GET" }).inputValidator(referenceModelSchema).handler(loadApiReferenceModelFn_createServerFn_handler, async ({ data }) => {
...
var loadReferenceNavServiceCountsFn = createServerFn({ method: "GET" }).inputValidator(referenceNavCountsSchema).handler(loadReferenceNavServiceCountsFn_createServerFn_handler, async ({ data }) => {
...
var loadReferenceOpenApiSpecFn = createServerFn({ method: "GET" }).inputValidator(referenceOpenApiSpecSchema).handler(loadReferenceOpenApiSpecFn_createServerFn_handler, async ({ data }) => {
...
export { loadApiReferenceModelFn_createServerFn_handler, loadApiReferenceServiceFn_createServerFn_handler, loadReferenceNavServiceCountsFn_createServerFn_handler, loadReferenceOpenApiSpecFn_createServerFn_handler };
