...
import { Nu as mapAppToMarketplaceApp, ku as useOrganizationApp } from "./hooks-BONwG3Mt.js";
...
import { t as Route$1 } from "./organizations._orgId.apps._appId-D0YMUhvT.js";
...
import { ArrowLeft, FileText, Key, KeyRound, LifeBuoy, Loader2, Rocket, Scale } from "lucide-react";
function buildOrgAppSettingsNavItems(orgId, appId, options) {
	const params = {
		orgId,
		appId
	};
	...
	if (options?.showSecrets) items.push({
		id: "secrets",
		label: "OAuth secrets",
		icon: Key,
...
function getOrgAppSettingsSectionId(pathname) {
...
function Layout({ initialData } = {}) {
	...
	const navItems = useMemo(() => orgId && appId ? buildOrgAppSettingsNavItems(orgId, appId, { showSecrets: app?.type !== "public" }) : [], [
		orgId,
		appId,
		app?.type
	]);
	...
	if (!app && !initialData?.app && !isLoading) return /* @__PURE__ */ jsx(ConsoleLayout, {
		header: {
			onCommandCenterOpen: () => {},
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(EmptyState, {
				...
				description: t("This app may have been deleted or you do not have access."),
				variant: "card"
			})
		})
	});
	if (!app || !mapped || !orgId || !appId) return /* @__PURE__ */ jsx(ConsoleLayout, {
		header: {
			onCommandCenterOpen: () => {},
			onCreateOrganization: () => {}
		},
	...
	return /* @__PURE__ */ jsx(ConsoleLayout, {
		header: {
			onCommandCenterOpen: () => {},
			onCreateOrganization: () => {}
		},
			...
			children: [/* @__PURE__ */ jsx(ServiceHeader, {
				title: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						isFetching ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 shrink-0 animate-spin text-muted-foreground" }) : null
					]
				}),
				titleRightContent: /* @__PURE__ */ jsx(MarketplaceAppBadges, { app: mapped }),
				showFilters: false,
...
function OrgAppLayoutRoute() {
	...
	const { appId } = Route$1.useParams();
	return /* @__PURE__ */ jsx(Layout, { initialData: loaderData ? { app: loaderData.app } : void 0 }, `org-app-layout-${appId}`);
}
export { OrgAppLayoutRoute as component };
