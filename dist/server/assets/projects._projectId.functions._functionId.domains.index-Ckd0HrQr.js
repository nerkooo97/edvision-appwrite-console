...
import { yr as useFunctionDomains } from "./affiliates-BOg1SHC6.js";
...
function View() {
	...
	const { data: domainsData, isLoading: domainsLoading, isFetching: domainsFetching } = useFunctionDomains(projectId, functionId, currentPage, pageSize, searchValue, filterMap.size > 0 ? Array.from(filterMap.values()) : void 0);
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		rules.length === 0 ? /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(EmptyState, {
				...
				description: hasFilters ? void 0 : t("Connect a custom domain to your function for a branded experience"),
				isEmpty: !hasFilters,
				hasFilters,
				variant: "card",
				iconSize: "md"
...
export { FunctionDomainsListPage as component };
