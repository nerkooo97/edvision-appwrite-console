...
import { $d as useMysqlActiveConnections, $m as matchesMysqlConnectionStateFilter, Km as formatMysqlConnectionUsername, Qd as useCancelMysqlBackend, Qm as matchesMysqlConnectionBackendScope, Rm as backendTypeBadgeVariant, Um as formatMysqlClientAddress, Vm as formatMysqlApplicationName, Wm as formatMysqlConnectionDatabase, Xm as isLongRunningConnection, Ym as formatMysqlWaitEvent, Zm as isMysqlClientBackend, af as useTerminateMysqlIdleInTransaction, eh as serializeMysqlActiveConnectionJson, if as useTerminateMysqlBackend, qm as formatMysqlDurationSince, zm as connectionStateBadgeVariant } from "./hooks-BONwG3Mt.js";
...
import { t as Route$1 } from "./projects._projectId.databases.mysql._databaseId.connections-DDz-dBIE.js";
...
import { n as localizeMysqlConnectionStateLabel, t as localizeMysqlBackendTypeLabel } from "./resource-status-labels-C-bLMJxj.js";
...
import "./mysql-chrome-BbKkgFlK.js";
import { t as MysqlSegmentedToggle } from "./MysqlSegmentedToggle-CT6Ox4UX.js";
...
function MysqlConnectionDrawer({ open, onOpenChange, connection, canManageConnections, manageDisabledTooltip, onOpenInSqlEditor, onCancelQuery, onTerminateConnection, isCancelPending, isTerminatePending }) {
	const t = useT();
	...
	const clientAddress = formatMysqlClientAddress(connection.clientHost, connection.clientPort);
	...
	const usernameLabel = formatMysqlConnectionUsername(connection.username, connection.backendType);
	const databaseLabel = formatMysqlConnectionDatabase(connection.database);
	const applicationLabel = formatMysqlApplicationName(connection.applicationName);
	const stateLabel = localizeMysqlConnectionStateLabel(connection.state, connection.backendType, t);
	const typeLabel = localizeMysqlBackendTypeLabel(connection.backendType, t);
	const waitEventLabel = formatMysqlWaitEvent(connection.waitEventType, connection.waitEvent);
...
function MysqlConnectionContextMenu({ connection, canManageConnections, onOpenDetails, onOpenInSqlEditor, onCancelQuery, onTerminateConnection, children }) {
	const t = useT();
	...
	return /* @__PURE__ */ jsxs(ContextMenu, { children: [/* @__PURE__ */ jsx(ContextMenuTrigger, {
		...
		children: [
			...
			/* @__PURE__ */ jsxs(ContextMenuSub, { children: [/* @__PURE__ */ jsxs(ContextMenuSubTrigger, { children: [/* @__PURE__ */ jsx(ContextMenuIcon, { icon: Copy }), t("Copy")] }), /* @__PURE__ */ jsxs(ContextMenuSubContent, { children: [
				...
				/* @__PURE__ */ jsxs(ContextMenuItem, {
					onSelect: () => void copyToClipboard("JSON", serializeMysqlActiveConnectionJson(connection)),
...
function MysqlConnectionRowActionsMenu({ connection, canManageConnections, onOpenDetails, onOpenInSqlEditor, onCancelQuery, onTerminateConnection }) {
	const t = useT();
...
function MysqlConnectionDetails({ projectId, databaseId, centerInPanel = false }) {
	const t = useT();
	const { openQueryTab } = useMysqlSidebar();
	...
	const { connections, isLoading, isFetching, error, refetch } = useMysqlActiveConnections(projectId, databaseId);
	const cancelMutation = useCancelMysqlBackend(projectId, databaseId);
	const terminateMutation = useTerminateMysqlBackend(projectId, databaseId);
	const terminateIdleMutation = useTerminateMysqlIdleInTransaction(projectId, databaseId);
	const scopedConnections = useMemo(() => connections.filter((connection) => matchesMysqlConnectionBackendScope(connection, backendScope)), [connections, backendScope]);
	const filteredConnections = useMemo(() => scopedConnections.filter((connection) => matchesMysqlConnectionStateFilter(connection, stateFilter)), [scopedConnections, stateFilter]);
	const clientConnectionCount = useMemo(() => connections.filter(isMysqlClientBackend).length, [connections]);
	const backendConnectionCount = useMemo(() => connections.filter((connection) => !isMysqlClientBackend(connection)).length, [connections]);
	const idleInTransactionCount = useMemo(() => connections.filter((connection) => isMysqlClientBackend(connection) && matchesMysqlConnectionStateFilter(connection, "idle in transaction")).length, [connections]);
	const filterCounts = useMemo(() => {
		...
		for (const connection of scopedConnections) {
			...
			if (matchesMysqlConnectionStateFilter(connection, "idle in transaction")) counts["idle in transaction"] += 1;
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex flex-wrap items-center gap-2",
								children: [/* @__PURE__ */ jsx(MysqlSegmentedToggle, {
									variant: "inline",
									value: backendScope,
									onValueChange: (value) => {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: isLoading && connections.length === 0 ? /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs(Table$1, {
								...
								children: [
									...
									/* @__PURE__ */ jsx(TableBody, { children: filteredConnections.map((connection) => {
										...
										const stateLabel = localizeMysqlConnectionStateLabel(connection.state, connection.backendType, t);
										const typeLabel = localizeMysqlBackendTypeLabel(connection.backendType, t);
										return /* @__PURE__ */ jsx(MysqlConnectionContextMenu, {
											connection,
											...
											children: /* @__PURE__ */ jsxs(TableRow, {
												...
												children: [
													...
													/* @__PURE__ */ jsx(TableCell, {
														...
														children: /* @__PURE__ */ jsx("span", {
															className: "text-[13px] text-muted-foreground",
															children: formatMysqlDurationSince(connection.queryStart ?? connection.backendStart)
														})
													}),
													/* @__PURE__ */ jsx(TableCell, {
														className: "min-w-0 whitespace-nowrap px-4 py-3",
														children: /* @__PURE__ */ jsx("span", {
															className: "block truncate text-[13px] text-muted-foreground",
															title: formatMysqlWaitEvent(connection.waitEventType, connection.waitEvent),
															children: formatMysqlWaitEvent(connection.waitEventType, connection.waitEvent)
														})
													}),
													/* @__PURE__ */ jsx(TableCell, {
														className: "min-w-0 whitespace-nowrap px-4 py-3",
													...
													/* @__PURE__ */ jsx(TableCell, {
														...
														children: /* @__PURE__ */ jsx("div", {
															...
															children: /* @__PURE__ */ jsx(MysqlConnectionRowActionsMenu, {
																connection,
																canManageConnections,
																onOpenDetails: () => openDrawer(connection),
																onOpenInSqlEditor: openInSqlEditor,
							...
							description: backendScope === "clients" && clientConnectionCount === 0 && backendConnectionCount > 0 ? t("Only MySQL system backends are running. Switch to Backends to inspect them.") : backendScope === "backends" && backendConnectionCount === 0 && clientConnectionCount > 0 ? t("Switch to Clients to inspect application sessions.") : stateFilter === "all" && backendScope === "clients" ? t("Client sessions will appear here when applications connect to this instance.") : void 0,
			...
			/* @__PURE__ */ jsx(MysqlConnectionDrawer, {
				open: drawerOpen,
				onOpenChange: (open) => {
					if (open) {
						setDrawerOpen(true);
...
function MysqlConnectionsPage() {
	...
	return /* @__PURE__ */ jsx(MysqlConnectionDetails, {
		projectId,
		databaseId
	});
}
export { MysqlConnectionsPage as component };
