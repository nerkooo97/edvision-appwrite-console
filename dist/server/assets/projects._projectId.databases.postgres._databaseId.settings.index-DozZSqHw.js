...
import { dg as useDeletePostgresDatabase } from "./hooks-BONwG3Mt.js";
...
import { n as PostgresDatabaseDetailsCard, r as PostgresDatabaseNameCard } from "./PostgresDatabaseGeneralSettings-BZcNSEP1.js";
...
function PostgresDatabaseDangerZoneCard({ projectId, database, canWrite }) {
	const t = useT();
...
function View() {
	const { projectId, databaseId, database, canWrite, permissionCanWrite, isLoading } = usePostgresDatabaseSettingsPage();
	...
	return /* @__PURE__ */ jsx(SettingsCardsList, { cards: [
		{
			...
			node: /* @__PURE__ */ jsx(PostgresDatabaseNameCard, { ...cardProps })
		},
		{
			id: "details",
			search: {
			...
			node: /* @__PURE__ */ jsx(PostgresDatabaseDetailsCard, { ...cardProps })
		},
		{
			id: "delete",
			search: {
			...
			node: /* @__PURE__ */ jsx(PostgresDatabaseDangerZoneCard, {
				projectId,
				database,
