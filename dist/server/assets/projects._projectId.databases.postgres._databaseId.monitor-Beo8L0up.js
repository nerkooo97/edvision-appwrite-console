...
import { B as DEDICATED_DATABASE_CPU_DESCRIPTION, B_ as formatPostgresUptime, F as useDedicatedDatabaseMonitorMetrics, H as DEDICATED_DATABASE_MEMORY_DESCRIPTION, J as getDedicatedDatabaseRateHeadline, M_ as formatConnectionStateLabel, U as DEDICATED_DATABASE_QPS_DESCRIPTION, V as DEDICATED_DATABASE_IOPS_DESCRIPTION, W as DEDICATED_DATABASE_STORAGE_DESCRIPTION, X as usageChartPointsToMonitorSeries, Y as mergeDualUsageChartSeries, bf as usePostgresMetricsSampling, hg as usePostgresDatabase, q as getDedicatedDatabaseGaugeHeadline, vf as usePostgresConnectionApps, xf as usePostgresTableActivity, yf as usePostgresConnectionStates, z as DEDICATED_DATABASE_CONNECTIONS_DESCRIPTION } from "./hooks-BONwG3Mt.js";
...
import { t as Route$1 } from "./projects._projectId.databases.postgres._databaseId.monitor-DXzkrTQI.js";
...
const POSTGRES_USAGE_PLACEHOLDER_NOTE = "Sample data only. Instance metrics will be provided by the usage service.";
...
function PostgresMetricRankedList({ id, title, description, items, formatValue = (value) => formatCompactBytes(value), emptyMessage = "No data available yet.", className }) {
	const t = useT();
...
function PostgresMetricKpiCard({ label, value, subValue, description, progress = null, progressTone = "normal", progressCaption, className }) {
	const t = useT();
	return /* @__PURE__ */ jsxs("div", {
...
function PostgresMetricBentoTile({ label, value, subValue, description, progress = null, progressTone = "normal", progressCaption }) {
	const t = useT();
	return /* @__PURE__ */ jsxs("div", {
...
function PostgresMetricsBentoCard({ title, tiles, columns = 3, className }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [title ? /* @__PURE__ */ jsx("div", {
			...
			children: rows.map((row, rowIndex) => /* @__PURE__ */ jsx("div", {
				...
				children: row.map((tile) => /* @__PURE__ */ jsx(PostgresMetricBentoTile, { ...tile }, tile.id))
			}, rowIndex))
		})]
	});
}
...
function PostgresMonitorNav({ navGroups, activeSectionId, onNavigate }) {
	const t = useT();
...
function View({ projectId, databaseId }) {
	...
	const { snapshot, lastRecordedAt, isLoading, isFetching, error, refresh } = usePostgresMetricsSampling(projectId, databaseId);
	const { states: connectionStates, isLoading: connectionStatesLoading, error: connectionStatesError } = usePostgresConnectionStates(projectId, databaseId);
	const { apps: connectionApps, isLoading: connectionAppsLoading, error: connectionAppsError } = usePostgresConnectionApps(projectId, databaseId);
	const { tables: tableActivity, isLoading: tableActivityLoading, error: tableActivityError } = usePostgresTableActivity(projectId, databaseId);
	...
	const scrollToChart = useCallback((id) => {
		...
		document.getElementById(`postgres-metric-chart-${id}`)?.scrollIntoView({
			behavior: "smooth",
			block: "start"
		});
	}, []);
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [metricsError ? /* @__PURE__ */ jsxs(Alert, {
					...
					children: [/* @__PURE__ */ jsx(PostgresMonitorNav, {
						navGroups,
						activeSectionId,
							...
							/* @__PURE__ */ jsxs("section", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx(PostgresMetricKpiCard, {
												label: t("Connections"),
									...
									snapshot ? /* @__PURE__ */ jsx("div", {
										...
										children: /* @__PURE__ */ jsx(PostgresMetricsBentoCard, {
											title: t("Health"),
											columns: 4,
											tiles: [
												{
													...
													description: "Time elapsed since the PostgreSQL server process last started."
												},
												{
													id: "server-started",
													label: "Server started",
													value: snapshot.serverStartedAt ? /* @__PURE__ */ jsx(DateTooltip, { date: new Date(snapshot.serverStartedAt) }) : "-",
													description: "When the PostgreSQL server process was last started."
												},
												{
													id: "commits",
													label: "Commits",
													...
													description: "Committed transactions since PostgreSQL statistics were last reset."
												},
												{
													id: "rollbacks",
													label: "Rollbacks",
													...
													description: "Rolled back transactions since PostgreSQL statistics were last reset."
												}
											]
										})
									}) : null
							...
							/* @__PURE__ */ jsxs("section", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										className: "space-y-6",
										children: [
											/* @__PURE__ */ jsx(PostgresMetricChart, {
												id: "cpu",
												title: t("CPU"),
												description: t(DEDICATED_DATABASE_CPU_DESCRIPTION),
												unit: "",
							...
							/* @__PURE__ */ jsxs("section", {
								...
								children: [/* @__PURE__ */ jsx(MonitorSectionHeading, { title: t("Connections") }), /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx(PostgresMetricRankedList, {
											id: "connection-states",
...
export { PostgresMonitorPage as component };
