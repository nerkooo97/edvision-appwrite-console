...
var $$splitComponentImporter = () => import("./projects._projectId.databases.postgres._databaseId.enums-Czw5T3bM.js");
const Route = createFileRoute("/_public/projects/$projectId/databases/postgres/$databaseId/enums")({
	head: () => ({ meta: [{ title: pageTitle(POSTGRES_DATABASE_TAB_LABELS.enums, "Databases") }] }),
