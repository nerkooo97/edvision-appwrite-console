...
var $$splitComponentImporter = () => import("./projects._projectId.databases._dbKind._databaseId.tables._tableId.settings-C7Jvvaul.js");
var TABLES_PER_PAGE = 100;
const Route = createFileRoute("/_public/projects/$projectId/databases/$dbKind/$databaseId/tables/$tableId/settings")({
	...
	loader: async ({ params, context }) => {
		...
		throwRedirectCollectionsDbFromTablesChild(dbKind, "settings", {
			projectId,
			dbKind,
			databaseId,
			tableId
