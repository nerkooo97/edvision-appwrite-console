...
var $$splitComponentImporter = () => import("./projects._projectId.databases._dbKind._databaseId.collections._collectionId.indexes-D58mA4B_.js");
var TABLES_PER_PAGE = 100;
const Route = createFileRoute("/_public/projects/$projectId/databases/$dbKind/$databaseId/collections/$collectionId/indexes")({
	...
	loader: async ({ params, context, search: routeSearch }) => {
		...
		await Promise.all([
			...
			queryClient.ensureQueryData(tableIndexesQueryOptions(projectId, databaseId, dbKind, collectionId, indexesFilterQueries, pageIndexed, limit)),
