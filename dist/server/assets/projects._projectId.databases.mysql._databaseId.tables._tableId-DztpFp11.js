...
import { f as parseMysqlTableId, l as normalizeMysqlTableRouteId, o as mysqlNav, p as parseMysqlTableTabFromPathname } from "./mysql-database-routes-CVHkJzTt.js";
...
import { t as MysqlTableHeaderSlotProvider } from "./MysqlTableHeaderSlotContext-DhaZhCAt.js";
import { jsx, jsxs } from "react/jsx-runtime";
import { Outlet, useLocation, useParams } from "@tanstack/react-router";
import { useCallback, useMemo, useState } from "react";
function MysqlTableHeader({ projectId, databaseId, tableId, activeTab, onCreate, createLabel, createDisabled, createDisabledTooltip, showRefresh, onRefresh, isRefreshing, searchPlaceholder, searchValue, onSearchChange, filterTrigger }) {
	const t = useT();
...
function MysqlTableLayout() {
	const { projectId, databaseId, tableId } = useParams({ strict: false });
	const location = useLocation();
	const normalizedTableId = normalizeMysqlTableRouteId(tableId);
	const activeTab = useMemo(() => parseMysqlTableTabFromPathname(location.pathname) ?? "rows", [location.pathname]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(MysqlTableHeader, {
				projectId,
				databaseId,
			...
			children: /* @__PURE__ */ jsx(MysqlTableHeaderSlotProvider, {
...
var SplitComponent = MysqlTableLayout;
