...
function DropdownMenuCheckboxItem({ className, children, checked, ...props }) {
	return /* @__PURE__ */ jsxs(DropdownMenuPrimitive.CheckboxItem, {
		...
		className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-pointer items-center gap-2 rounded-sm py-1.5 pe-2 ps-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className),
		checked,
		...props,
...
function DropdownMenuSubTrigger({ className, inset, children, ...props }) {
	return /* @__PURE__ */ jsxs(DropdownMenuPrimitive.SubTrigger, {
		...
		...props,
		children: [children, /* @__PURE__ */ jsx(ChevronRightIcon, { className: "ms-auto size-4" })]
	});
}
...
export { DropdownMenuItem as a, DropdownMenuRadioItem as c, DropdownMenuSubContent as d, DropdownMenuSubTrigger as f, DropdownMenuGroup as i, DropdownMenuSeparator as l, DropdownMenuCheckboxItem as n, DropdownMenuLabel as o, DropdownMenuTrigger as p, DropdownMenuContent as r, DropdownMenuRadioGroup as s, DropdownMenu as t, DropdownMenuSub as u };
