...
import { n as useFunctionWizard, t as FunctionWizardProvider } from "./WizardContext-CgxZR-_v.js";
import { jsx } from "react/jsx-runtime";
import { Outlet, useParams } from "@tanstack/react-router";
import { useEffect } from "react";
import { useQuery } from "@tanstack/react-query";
function CreateFunctionLayout() {
	return /* @__PURE__ */ jsx(FunctionWizardProvider, { children: /* @__PURE__ */ jsx(CreateFunctionLayoutInner, {}) });
}
function CreateFunctionLayoutInner() {
	const { projectId } = useParams({ strict: false });
	const { setInstallations, setBaseDomain, setRegion } = useFunctionWizard();
	const { data: installationsData } = useQuery(vcsInstallationsQueryOptions(projectId, 0, 100));
...
export { CreateFunctionLayout as component };
