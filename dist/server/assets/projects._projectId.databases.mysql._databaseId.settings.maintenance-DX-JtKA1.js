...
import { rm as useUpdateMysqlDatabaseMaintenance } from "./hooks-BONwG3Mt.js";
...
function useMysqlMaintenanceWindow({ projectId, databaseId, database, canWrite }) {
	const t = useT();
	const maintenanceMutation = useUpdateMysqlDatabaseMaintenance(projectId, databaseId);
...
function MysqlDatabaseMaintenanceCard({ projectId, databaseId, database, canWrite }) {
	const { t, maintenanceDay, setMaintenanceDay, maintenanceHour, setMaintenanceHour, writeDisabled, writeTooltip, maintenanceDirty, handleMaintenanceUpdate } = useMysqlMaintenanceWindow({
		projectId,
		databaseId,
		database,
		canWrite
...
function View() {
	...
	return /* @__PURE__ */ jsx(SettingsCardsList, { cards: [{
		...
		node: /* @__PURE__ */ jsx(MysqlDatabaseMaintenanceCard, {
			projectId,
			databaseId,
			database,
			canWrite
