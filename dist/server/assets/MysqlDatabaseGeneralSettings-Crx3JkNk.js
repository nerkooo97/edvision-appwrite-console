...
import { nm as useUpdateMysqlDatabase } from "./hooks-BONwG3Mt.js";
...
function MysqlDatabaseNameCard({ projectId, databaseId, database, canWrite }) {
	const t = useT();
...
function MysqlDatabaseDetailsCard({ projectId, databaseId, database, canWrite }) {
	const t = useT();
	const updateMutation = useUpdateMysqlDatabase(projectId, databaseId);
...
function MysqlDatabaseComputeTierCard({ projectId, databaseId, database, canWrite }) {
	const t = useT();
...
export { MysqlDatabaseDetailsCard as n, MysqlDatabaseNameCard as r, MysqlDatabaseComputeTierCard as t };
