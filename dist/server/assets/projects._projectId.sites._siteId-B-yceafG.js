...
import "./CreateManualDeploymentModal-CZJSSa3W.js";
import "./RepositoryPicker-BTzJ0oV8.js";
import { n as Layout } from "./Layout-DkdBPWi2.js";
import { jsx } from "react/jsx-runtime";
import { Outlet, useMatches } from "@tanstack/react-router";
function SiteLayoutPage() {
	if (useMatches().some((match) => match.routeId.includes("/deployments/$deploymentId") || match.routeId === "/_public/projects/$projectId/sites/$siteId/deployments/$deploymentId" || match.routeId === "/_public/projects/$projectId/sites/$siteId/deployments/$deploymentId/" || match.routeId.startsWith("/_public/projects/$projectId/sites/$siteId/deployments/$deploymentId"))) return /* @__PURE__ */ jsx(Outlet, {});
	return /* @__PURE__ */ jsx("div", {
		className: "flex h-full min-h-0 flex-1 flex-col",
		children: /* @__PURE__ */ jsx(Layout, {})
	});
}
export { SiteLayoutPage as component };
