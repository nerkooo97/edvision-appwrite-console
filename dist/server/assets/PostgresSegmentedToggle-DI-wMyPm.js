...
import { n as POSTGRES_SEGMENTED_TOGGLE_ITEM_CLASS } from "./postgres-chrome-B-StjUdY.js";
import { jsx } from "react/jsx-runtime";
function PostgresSegmentedToggle({ value, onValueChange, options, ariaLabel, variant = "inline", className }) {
	const t = useT();
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(ToggleGroup, {
			...
			children: options.map((option) => /* @__PURE__ */ jsx(ToggleGroupItem, {
				value: option.value,
				className: cn(POSTGRES_SEGMENTED_TOGGLE_ITEM_CLASS, variant === "inline" && "min-w-[5.5rem] px-3"),
				children: t(option.label)
			}, option.value))
		})
	});
}
export { PostgresSegmentedToggle as t };
