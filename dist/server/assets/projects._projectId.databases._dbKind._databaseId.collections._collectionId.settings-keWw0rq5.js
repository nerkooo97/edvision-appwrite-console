...
var $$splitComponentImporter = () => import("./projects._projectId.databases._dbKind._databaseId.collections._collectionId.settings-DJZXPdVX.js");
var TABLES_PER_PAGE = 100;
const Route = createFileRoute("/_public/projects/$projectId/databases/$dbKind/$databaseId/collections/$collectionId/settings")({
	...
	loader: async ({ params, context }) => {
		...
		throwRedirectTablesDbFromCollectionsChild(dbKind, "settings", {
			projectId,
			dbKind,
			databaseId,
			collectionId
