import { B as COVER_TABLE_GRID, C as DEFAULT_CLI_CODE_SUBTITLE, E as DEFAULT_CLI_TERMINAL_TITLE, S as DEFAULT_CLI_CODE, T as DEFAULT_CLI_TERMINAL_ICON, Y as COVER_SCREENSHOT_ANGLED_3D_LIMITS, a as COVER_CODE_SNIPPET_LANGUAGE_LABELS, c as DEFAULT_CODE_SNIPPET_TITLE, gt as COVER_SCREENSHOT_FRAME_HEIGHT, i as COVER_CODE_SNIPPET_LANGUAGES, k as COVER_CHART, o as DEFAULT_CODE_SNIPPET, r as COVER_CODE_SNIPPET_FONT_SIZE, vt as COVER_SCREENSHOT_FRAME_WIDTH, w as DEFAULT_CLI_CODE_TITLE } from "./constants-B5zUV45z.js";
import { c as COVER_MILESTONE_FIELD_DEFINITIONS, o as COVER_VERSION_NUMBER_FIELD_DEFINITIONS, s as COVER_VERSION_TITLE_FIELD_DEFINITIONS, t as DEFAULT_COVER_VALUES, u as COVER_CARDS_ANGLED_GRID } from "./parse-params-BpMT2Ilk.js";
var COVER_SCREENSHOT_ANGLED_3D_TEMPLATE_FIELDS = [
	{
		key: "displayScale",
		label: "Scale",
		type: "range",
...
var COVER_SCREENSHOT_FRAME_WIDTH_FIELD = {
...
var COVER_SCREENSHOT_ANGLED_TEMPLATE_FIELDS = [
	{
		key: "screenshot",
		label: "Screenshot",
		type: "image",
	...
	},
	{
		...
		description: "Card width relative to the current template size (100% fills the template width). Height follows 16:9."
	},
	...COVER_SCREENSHOT_ANGLED_3D_TEMPLATE_FIELDS
];
var COVER_SCREENSHOT_FRAME_HEIGHT_FIELD = {
	...
	unit: "%",
	description: "Height as a share of the space below the title down to the bottom edge (100% is as tall as possible)."
};
var COVER_SCREENSHOT_TEMPLATE_FIELDS = [
...
var COVER_SCREENSHOT_SIDE_FRAME_WIDTH_FIELD = {
	...COVER_SCREENSHOT_FRAME_WIDTH_FIELD,
	label: "Screenshot width",
	description: "Width of the browser frame. Part of the right edge overflows and is clipped."
};
var COVER_SCREENSHOT_SIDE_FRAME_HEIGHT_FIELD = {
	...COVER_SCREENSHOT_FRAME_HEIGHT_FIELD,
	label: "Screenshot height",
	description: "Height relative to the available vertical space. Inner content keeps a 16:9 aspect ratio."
};
var COVER_SCREENSHOT_SIDE_TEMPLATE_FIELDS = [
	...COVER_SCREENSHOT_ANGLED_TEMPLATE_FIELDS.slice(0, 4),
...
var COVER_CARDS_ANGLED_TEMPLATE_FIELDS = [
	{
		key: "columns",
		label: "Columns",
		type: "range",
	...
	...COVER_SCREENSHOT_ANGLED_3D_TEMPLATE_FIELDS.map((field) => field.key === "displayScale" ? {
		...field,
		description: "Overall card grid size from the bottom-right corner."
	} : field)
];
var COVER_TABLE_TEMPLATE_FIELDS = [
	{
		key: "title",
		label: "Title",
		type: "textarea",
...
var COVER_CHART_TEMPLATE_FIELDS = [
	{
		key: "title",
		label: "Title",
		type: "textarea",
...
var COVER_CLI_CODE_TEMPLATE_FIELDS = [
	{
		key: "title",
		label: "Title",
		type: "textarea",
...
var COVER_CODE_SNIPPET_TEMPLATE_FIELDS = [
	{
		key: "title",
		label: "Title",
		type: "text",
...
const COVER_TEMPLATE_DEFINITIONS = [
	{
		id: "simple-title",
		label: "Simple title",
	...
	},
	{
		...
		description: "Product screenshot in a browser frame from the right with title copy on the left.",
		fields: COVER_SCREENSHOT_SIDE_TEMPLATE_FIELDS
	},
	{
		id: "screenshot-angled",
		label: "Screenshot angled",
		description: "Product screenshot in a floating browser frame with a subtle perspective tilt.",
		fields: COVER_SCREENSHOT_ANGLED_TEMPLATE_FIELDS
	},
	{
		id: "cards-angled",
		label: "Cards angled",
		description: "Grid of integration icon cards in a floating glass layout with perspective tilt.",
...
function getCoverTemplateDefinition(templateId) {
	return COVER_TEMPLATE_DEFINITIONS.find((item) => item.id === templateId);
}
export { getCoverTemplateDefinition as n, COVER_TEMPLATE_DEFINITIONS as t };
