...
import { wg as usePostgresSchemaVisualizer } from "./hooks-BONwG3Mt.js";
...
import { t as Route$1 } from "./projects._projectId.databases.postgres._databaseId.visualizer-Cu47kfYK.js";
...
import { b as formatPostgresColumnType } from "./postgres-table-ddl-vL4Zatvb.js";
...
function PostgresSchemaVisualizer({ databaseId }) {
	const t = useT();
	const { projectId } = useParams({ strict: false });
	const navigate = useNavigate();
	const { selectedSchema } = usePostgresSidebar();
	const { relations, relationships, totalRelations, loadedRelations, isLoading, isLoadingColumns, isComplete, error } = usePostgresSchemaVisualizer(projectId, databaseId, selectedSchema);
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: node.columns.length > 0 ? /* @__PURE__ */ jsxs("div", {
						...
						children: [visibleColumns.map((column) => {
							...
							const typeLabel = formatPostgresColumnType({ data_type: column.dataType });
							return /* @__PURE__ */ jsxs("div", {
...
function PostgresVisualizerPage() {
	...
	return /* @__PURE__ */ jsx(PostgresSchemaVisualizer, { databaseId });
}
export { PostgresVisualizerPage as component };
