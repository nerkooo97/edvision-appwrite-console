...
import { mn as useProjectSite, sn as useCreateSiteDomainRule } from "./affiliates-BOg1SHC6.js";
...
function AddDomainWizard() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			await ensureApexDomainInOrganization(project?.teamId ?? "", d, { skipForSites: true });
		} catch (err) {
