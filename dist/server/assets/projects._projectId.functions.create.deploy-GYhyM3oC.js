...
import { t as Route } from "./projects._projectId.functions.create.deploy-J-3h4g6i.js";
...
import { ID, TemplateReferenceType } from "@appwrite.io/console";
...
function DeployFromUrlView({ repoFromSearch, runtimeFromSearch, entrypointFromSearch, installFromSearch, rootDirFromSearch }) {
	const t = useT();
	...
	return /* @__PURE__ */ jsxs(WizardLayout, {
		...
		footer: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Button, {
			...
			disabled: isDeploying || !parsed || !functionName || !runtime || !domain.trim() || !domainValid,
			children: t("Create and deploy")
		})] }),
		children: [
			!parsed && /* @__PURE__ */ jsx("div", {
				className: "rounded-xl border border-border bg-card/50 p-6 mb-6",
				children: /* @__PURE__ */ jsxs("p", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("code", {
							className: "bg-muted px-1 rounded",
							children: "?repository=owner/repo"
						}),
						"."
					]
				})
...
function DeployFromUrlPage() {
	...
	return /* @__PURE__ */ jsx(DeployFromUrlView, {
...
export { DeployFromUrlPage as component };
